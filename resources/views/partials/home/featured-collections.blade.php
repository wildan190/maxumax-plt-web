...
<section class="bg-[#050505] py-24 px-6 border-y border-white/5">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ $col['href'] }}" class="group relative aspect-[16/9] rounded-2xl overflow-hidden bg-[#111] border border-white/5 block">
                <img src="{{ $col['img'] }}" alt="{{ $col['label'] }}" class="w-full h-full object-cover opacity-60 group-hover:opacity-100 transition-opacity duration-500 group-hover:scale-105">
                <div class="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent"></div>
                <div class="absolute bottom-6 left-6 right-6">
                    <h3 class="text-white font-black text-xl md:text-2xl uppercase tracking-widest leading-tight group-hover:text-blue-400 transition-colors">{{ $col['label'] }}</h3>
