                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <span class="text-xs text-slate-400">{{ $order->currency }}</span>
                                    <span class="font-medium text-slate-900">{{ number_format($order->total_amount / $order->quantity, 2) }}</span>
                                </td>
                                <td class="px-6 py-4 text-right">
                                    <span class="text-xs text-slate-400">{{ $order->currency }}</span>
                        ...
                        <tfoot class="bg-slate-50/30">
                            <tr>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <span class="text-xs text-indigo-400 font-bold mr-1">{{ $order->currency }}</span>
