...
">
    ...
    <form method="GET"
          action="{{ route('admin.orders.history') }}"
          style="display: flex; gap: 0.5rem; flex-wrap: wrap; max-width: 100%;">
        <input
            type="text"
            name="search"
            ...
            <tbody>
                @forelse($orders as $o)
                    ...
                    <tr style="border-bottom:1px solid #e5e7eb;">
                        ...
                        <td style="padding:1rem; font-size:0.85rem; color:#6b7280;">
