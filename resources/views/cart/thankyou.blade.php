...
@section('content')
    <section class="thankyou-container">
        <div class="success-header">
            ...
            @if($status === 'paid')
                <span class="status-badge" style="background: #dcfce7; color: #166534; border-color: #bbf7d0;">Status: Payment
                    Successful</span>
            @elseif($status === 'confirmed')
                <span class="status-badge" style="background: #e0f2fe; color: #075985; border-color: #bae6fd;">Status:
                    Confirmed</span>
            @else
            ...
            @if(isset($orders) && count($orders))
                    ...
                    @foreach($orders as $o)
                        <div class="order-item">
                            ...
                            <div class="order-status">
                                <span
                                    style="font-size: 0.8rem; padding: 0.25rem 0.5rem; border-radius: 4px; background: #f3f4f6; color: #4b5563;">
                                    {{ ucfirst($o->status) }}
                                </span>
                            </div>
                        </div>
                ...
                <div class="info-box">
                    ...
                    <p class="info-box-text">
                        ...
                        @else
                            For COD orders, payment will be collected upon delivery. You will receive a confirmation call or message
                            from us soon.
                        @endif
                    </p>
                </div>
