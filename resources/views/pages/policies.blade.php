...
@section('content')
    <div class="bg-black min-h-screen pt-32 pb-40 px-6 overflow-hidden relative">
        <!-- Background Accents -->
        <div
            class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[60vh] bg-gradient-to-b from-blue-600/10 via-transparent to-transparent pointer-events-none">
        </div>

        <div class="max-w-4xl mx-auto relative z-10">
            <!-- Header Section -->
            <div class="text-center mb-24 animate-fade-in text-focus-in">
                <span class="text-blue-500 font-black uppercase tracking-[0.4em] text-[10px] mb-6 inline-block">Legal
                    Framework</span>
            ...
            <div class="space-y-12 animate-fade-in-up">
                ...
                <div class="bg-[#111111] border border-white/5 rounded-[3rem] p-10 md:p-16 shadow-3xl">
                    <div class="flex items-center gap-6 mb-12 border-b border-white/5 pb-8">
                        <div
                            ...
                            <i data-feather="lock" class="text-blue-500 w-6 h-6"></i>
                        </div>
                        <h2 class="text-3xl font-black text-white italic uppercase tracking-tighter">1. Privacy Policy.</h2>
                    </div>
                    ...
                    <div class="prose prose-invert prose-blue max-w-none space-y-10">
                        ...
                        <div class="space-y-6">
                            ...
                            <p class="text-white/40 text-[11px] font-bold leading-relaxed uppercase tracking-widest">
                            ...
                            <ul
                                ...
                                <li class="flex items-center gap-3"><i data-feather="check"
                                        class="w-3 h-3 text-blue-500/40"></i> Full Name</li>
                                <li class="flex items-center gap-3"><i data-feather="check"
                                        class="w-3 h-3 text-blue-500/40"></i> Email Address</li>
                                <li class="flex items-center gap-3"><i data-feather="check"
                                        class="w-3 h-3 text-blue-500/40"></i> Phone Number</li>
                                <li class="flex items-center gap-3"><i data-feather="check"
                                        class="w-3 h-3 text-blue-500/40"></i> Billing and Shipping Addresses</li>
                                <li class="flex items-center gap-3"><i data-feather="check"
                                        class="w-3 h-3 text-blue-500/40"></i> Order and Transaction Details</li>
                                <li class="flex items-center gap-3"><i data-feather="check"
                                        class="w-3 h-3 text-blue-500/40"></i> IP address, device type, and browser
                                    information</li>
                            </ul>
                        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <ul
                                ...
                                <li class="flex items-center gap-3"><i data-feather="arrow-right"
                                        class="w-3 h-3 text-blue-500/40"></i> To process, fulfill, and deliver your orders
                                </li>
                                <li class="flex items-center gap-3"><i data-feather="arrow-right"
                                        class="w-3 h-3 text-blue-500/40"></i> To communicate with you regarding orders,
                                    refunds, or customer support</li>
                                <li class="flex items-center gap-3"><i data-feather="arrow-right"
                                        class="w-3 h-3 text-blue-500/40"></i> To improve our website, products, and services
                                </li>
                                <li class="flex items-center gap-3"><i data-feather="arrow-right"
                                        class="w-3 h-3 text-blue-500/40"></i> To detect, prevent, and address fraud or
                                    unauthorized transactions</li>
                                <li class="flex items-center gap-3"><i data-feather="arrow-right"
                                        class="w-3 h-3 text-blue-500/40"></i> To comply with legal and regulatory
                                    requirements</li>
                            </ul>
                        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <ul
                                ...
                                <li class="flex items-center gap-3"><i data-feather="share-2"
                                        class="w-3 h-3 text-blue-500/40"></i> Payment service providers</li>
                                <li class="flex items-center gap-3"><i data-feather="share-2"
                                        class="w-3 h-3 text-blue-500/40"></i> Shipping and logistics partners</li>
                                <li class="flex items-center gap-3"><i data-feather="share-2"
                                        class="w-3 h-3 text-blue-500/40"></i> Government or regulatory authorities when
                                    required by law</li>
                            </ul>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="bg-black/40 border border-white/5 rounded-3xl p-8 space-y-4">
                                <h3 class="text-white font-black uppercase tracking-widest text-[10px]">Payment Security
                                </h3>
                                <p
                                    class="text-white/40 text-[10px] font-bold leading-relaxed uppercase tracking-widest m-0">
                            ...
                            <div class="bg-black/40 border border-white/5 rounded-3xl p-8 space-y-4">
                                <h3 class="text-white font-black uppercase tracking-widest text-[10px]">Cookies</h3>
                                <p
                                    class="text-white/40 text-[10px] font-bold leading-relaxed uppercase tracking-widest m-0">
                        ...
                        <div class="bg-blue-500/5 border border-blue-500/10 rounded-3xl p-8">
                            <h3 class="text-blue-500 font-black uppercase tracking-widest text-xs mb-4">Data Protection</h3>
                            <p class="text-white/40 text-[11px] font-bold leading-relaxed uppercase tracking-widest m-0">
                ...
                <div class="bg-[#111111] border border-white/5 rounded-[3rem] p-10 md:p-16 shadow-3xl">
                    <div class="flex items-center gap-6 mb-12 border-b border-white/5 pb-8">
                        <div
                            ...
                            <i data-feather="refresh-ccw" class="text-emerald-500 w-6 h-6"></i>
                        </div>
                        <h2 class="text-3xl font-black text-white italic uppercase tracking-tighter">2. Refund & Return
                            Policy.</h2>
                    </div>
                    ...
                    <div class="prose prose-invert prose-emerald max-w-none space-y-10">
                        ...
                        <div class="space-y-6">
                            <h3 class="text-white font-black uppercase tracking-widest text-xs">How to Request a Return</h3>
                            <div class="bg-emerald-500/5 border border-emerald-500/10 rounded-3xl p-8">
                                <p class="text-white/60 text-xs font-bold leading-relaxed uppercase tracking-widest mb-4">
                                    CONTACT US VIA EMAIL AT: <span class="text-emerald-500">MAXUMAX.MY@GMAIL.COM</span>
                                </p>
                                <p class="text-white/30 text-[10px] font-black uppercase tracking-[0.2em] mb-4">Include the
                                    following details:</p>
                                <ul
                                    class="grid grid-cols-1 md:grid-cols-2 gap-3 text-[10px] text-white/40 font-black uppercase tracking-widest list-none p-0">
                                    <li class="flex items-center gap-3"><i data-feather="user"
                                            class="w-3 h-3 text-emerald-500"></i> Customer Name</li>
                                    <li class="flex items-center gap-3"><i data-feather="hash"
                                            class="w-3 h-3 text-emerald-500"></i> Order Number</li>
                                    <li class="flex items-center gap-3"><i data-feather="file-text"
                                            class="w-3 h-3 text-emerald-500"></i> Reason for Return</li>
                                    <li class="flex items-center gap-3"><i data-feather="camera"
                                            class="w-3 h-3 text-emerald-500"></i> Clear Photos</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="space-y-6">
                                <h3 class="text-white font-black uppercase tracking-widest text-xs">Refund Process</h3>
                                <ul
                                    class="space-y-3 text-white/40 font-bold text-[11px] uppercase tracking-widest list-none p-0">
                                    ...
                                    <li class="flex items-start gap-3"><i data-feather="check-circle"
                                            ...
                                            method</span></li>
                                    <li class="flex items-start gap-3"><i data-feather="check-circle"
                                            class="w-3 h-3 text-emerald-500 mt-1"></i> <span>7–14 working days
                                            processing</span></li>
                                </ul>
                            </div>
                            <div class="space-y-6">
                                <h3 class="text-white font-black uppercase tracking-widest text-xs">Non-Refundable Items
                                </h3>
                                <ul
                                    class="space-y-3 text-white/40 font-bold text-[11px] uppercase tracking-widest list-none p-0">
                                    <li class="flex items-start gap-3"><i data-feather="x-circle"
                                            class="w-3 h-3 text-red-500/60 mt-1"></i> <span>Promotional or discounted
                                            items</span></li>
                                    <li class="flex items-start gap-3"><i data-feather="x-circle"
                                            class="w-3 h-3 text-red-500/60 mt-1"></i> <span>Used, worn, or damaged
                                            items</span></li>
                                    <li class="flex items-start gap-3"><i data-feather="x-circle"
                                            class="w-3 h-3 text-red-500/60 mt-1"></i> <span>Digital products</span></li>
                                </ul>
                            </div>
                        </div>

                        <div class="bg-black/40 border border-white/5 rounded-3xl p-8">
                            <h3 class="text-white font-black uppercase tracking-widest text-xs mb-4">Shipping Costs</h3>
                            <ul
                                class="space-y-3 text-white/40 font-bold text-[11px] uppercase tracking-widest list-none p-0">
                ...
                <div class="bg-[#111111] border border-white/5 rounded-[3rem] p-10 md:p-16 shadow-3xl">
                    <div class="flex items-center gap-6 mb-12 border-b border-white/5 pb-8">
                        <div class="w-12 h-12 bg-blue-500/10 rounded-2xl flex items-center justify-center border border-blue-500/20">
                            <i data-feather="truck" class="text-blue-500 w-6 h-6"></i>
                        </div>
                        <h2 class="text-3xl font-black text-white italic uppercase tracking-tighter">3. Shipping Policy.</h2>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <!-- Changes to Policies -->
                    <div class="bg-[#111111] border border-white/5 rounded-[3rem] p-10 md:p-12 shadow-3xl">
                        <div class="flex items-center gap-4 mb-8">
                            <div class="w-10 h-10 bg-amber-500/10 rounded-xl flex items-center justify-center border border-amber-500/20">
                                <i data-feather="edit-3" class="text-amber-500 w-5 h-5"></i>
                            </div>
                            <h2 class="text-xl font-black text-white uppercase italic tracking-tighter">4. Changes.</h2>
                        </div>
                    ...
                    <div class="bg-[#111111] border border-white/5 rounded-[3rem] p-10 md:p-12 shadow-3xl">
                        <div class="flex items-center gap-4 mb-8">
                            ...
                            <h2 class="text-xl font-black text-white uppercase italic tracking-tighter">5. Contact Us.</h2>
                        </div>
                        <div class="space-y-4">
                            <p class="text-white/40 text-[10px] font-bold uppercase tracking-widest">If you have any questions, please reach out:</p>
                            <ul class="space-y-3 text-[10px] text-white/60 font-black uppercase tracking-widest list-none p-0">
                                <li class="flex items-center gap-3"><i data-feather="mail" class="w-3 h-3 text-blue-500"></i> maxumax.my@gmail.com</li>
                                <li class="flex items-center gap-3"><i data-feather="globe" class="w-3 h-3 text-blue-500"></i> https://maxumax.my</li>
                                <li class="flex items-center gap-3"><i data-feather="phone" class="w-3 h-3 text-blue-500"></i> +60143436496</li>
                            </ul>
                        </div>
                    </div>
                </div>
